'''
Original script from https://www.datacamp.com/community/tutorials/gui-tkinter-python
Calculator made with tkinter
'''
from tkinter import *

window = Tk()
window.geometry("484x364") # size of the window width: 500, height: 375
window.resizable(0, 0) # this prevents from resizing the window
window.title("Calculator")

#######Functions#######
# btn click updates input field whenever enter a number
def btn_click(item):
	global expression
	expression = expression + str(item)
	input_text.set(expression)
# btn clear clears the input field
def btn_clear():
	global expression
	expression = ""
	input_text.set("")
# btn equal calculates the expression present in input field
def btn_equal():
	global expression
...
expression = ""
# StringVar() get instance input field
